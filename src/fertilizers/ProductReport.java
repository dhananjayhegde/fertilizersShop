 ...
 * @author ProjectTeam
 */
public class ProductReport extends AbstractForm {

    private ALVTableModel alvModel;
    
    public ProductReport(JFrame prev){
        super(prev);
        initComponents();
        initialize();
    ...
    private void initComponents() {
        ...
        jlbanner.setText("Supplier Report");
    ...
    private void initialize() {
        ...
        try {
            ...
            if (this.rs.getMetaData().getColumnCount() <= 0) {
                this.jlmsg.setText("No products yet");
            }
        } catch (SQLException ex) {
            Logger.getLogger(FarmerAccountsForm.class.getName()).log(Level.SEVERE, null, ex);
            this.jlmsg.setText("Some problem fetching the products report. Try after some time!!");
        }
    }
}
